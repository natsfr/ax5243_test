# 1 "AX5043_NBM/src/radioCommands.c"
...
# 2 "AX5043_NBM/src/radioCommands.c" 2

# 1 "AX5043_NBM/inc/radioCommands.h" 1
...
# 12 "AX5043_NBM/inc/AX5043/ax5043_interface.h"
typedef struct {
...
# 9 "AX5043_NBM/inc/radioCommands.h" 2
...
# 10 "AX5043_NBM/inc/radioCommands.h" 2
# 1 "AX5043_NBM/inc/AX5043/ax5043_general.h" 1
# 14 "AX5043_NBM/inc/AX5043/ax5043_general.h"
typedef enum {
 RadioState_Idle = 0,
...
# 11 "AX5043_NBM/inc/radioCommands.h" 2
# 1 "AX5043_NBM/inc/AX5043/ax5043_gpio.h" 1
# 11 "AX5043_NBM/inc/AX5043/ax5043_gpio.h"
typedef union {
 struct {
  uint8_t sysClk : 1;
  uint8_t dClk : 1;
...
# 12 "AX5043_NBM/inc/radioCommands.h" 2
# 1 "AX5043_NBM/inc/AX5043/ax5043_interface.h" 1
# 13 "AX5043_NBM/inc/radioCommands.h" 2
# 1 "AX5043_NBM/inc/AX5043/ax5043_irq.h" 1
# 15 "AX5043_NBM/inc/AX5043/ax5043_irq.h"
typedef union {
 struct {
...
# 14 "AX5043_NBM/inc/radioCommands.h" 2
...
# 15 "AX5043_NBM/inc/radioCommands.h" 2
...
# 16 "AX5043_NBM/inc/radioCommands.h" 2
...
# 17 "AX5043_NBM/inc/radioCommands.h" 2
...
# 18 "AX5043_NBM/inc/radioCommands.h" 2
...
# 19 "AX5043_NBM/inc/radioCommands.h" 2
...
# 20 "AX5043_NBM/inc/radioCommands.h" 2
# 1 "AX5043_NBM/inc/AX5043/ax5043_synth.h" 1
# 17 "AX5043_NBM/inc/AX5043/ax5043_synth.h"
typedef enum {
...
# 21 "AX5043_NBM/inc/radioCommands.h" 2
...
# 22 "AX5043_NBM/inc/radioCommands.h" 2
# 1 "AX5043_NBM/inc/AX5043/ax5043_txparam.h" 1
# 15 "AX5043_NBM/inc/AX5043/ax5043_txparam.h"
typedef enum {
 FreqShape_invalid = 0,
...
# 23 "AX5043_NBM/inc/radioCommands.h" 2
...
# 25 "AX5043_NBM/inc/radioCommands.h" 2
...
# 4 "AX5043_NBM/src/radioCommands.c" 2

# 1 "AX5043_NBM/inc/radio.h" 1



# 1 "/opt/microchip/xc16/v2.00/bin/bin/../../include/math.h" 1 3 4
# 9 "/opt/microchip/xc16/v2.00/bin/bin/../../include/math.h" 3 4
# 1 "/opt/microchip/xc16/v2.00/bin/bin/../../include/features.h" 1 3 4
# 10 "/opt/microchip/xc16/v2.00/bin/bin/../../include/math.h" 2 3 4



# 1 "/opt/microchip/xc16/v2.00/bin/bin/../../include/bits/alltypes.h" 1 3 4
# 47 "/opt/microchip/xc16/v2.00/bin/bin/../../include/bits/alltypes.h" 3 4
...
# 14 "/opt/microchip/xc16/v2.00/bin/bin/../../include/math.h" 2 3 4
# 40 "/opt/microchip/xc16/v2.00/bin/bin/../../include/math.h" 3 4
...
# 77 "/opt/microchip/xc16/v2.00/bin/bin/../../include/math.h" 3 4
int __signbit(double);
int __signbitf(float);
int __signbitl(long double);
# 91 "/opt/microchip/xc16/v2.00/bin/bin/../../include/math.h" 3 4
static inline int __islessf(float_t __x, float_t __y) { return !(( sizeof((__x)) == sizeof(float) ? (__FLOAT_BITS((__x)) & 0x7fffffff) > 0x7f800000 : (__LONG_DOUBLE_BITS((__x)) & -1ULL>>1) > 0x7ffULL<<52 ) ? ((void)(__y),1) : ( sizeof((__y)) == sizeof(float) ? (__FLOAT_BITS((__y)) & 0x7fffffff) > 0x7f800000 : (__LONG_DOUBLE_BITS((__y)) & -1ULL>>1) > 0x7ffULL<<52 )) && __x < __y; }
static inline int __isless(double_t __x, double_t __y) { return !(( sizeof((__x)) == sizeof(float) ? (__FLOAT_BITS((__x)) & 0x7fffffff) > 0x7f800000 : (__LONG_DOUBLE_BITS((__x)) & -1ULL>>1) > 0x7ffULL<<52 ) ? ((void)(__y),1) : ( sizeof((__y)) == sizeof(float) ? (__FLOAT_BITS((__y)) & 0x7fffffff) > 0x7f800000 : (__LONG_DOUBLE_BITS((__y)) & -1ULL>>1) > 0x7ffULL<<52 )) && __x < __y; }
static inline int __islessl(long double __x, long double __y) { return !(( sizeof((__x)) == sizeof(float) ? (__FLOAT_BITS((__x)) & 0x7fffffff) > 0x7f800000 : (__LONG_DOUBLE_BITS((__x)) & -1ULL>>1) > 0x7ffULL<<52 ) ? ((void)(__y),1) : ( sizeof((__y)) == sizeof(float) ? (__FLOAT_BITS((__y)) & 0x7fffffff) > 0x7f800000 : (__LONG_DOUBLE_BITS((__y)) & -1ULL>>1) > 0x7ffULL<<52 )) && __x < __y; }
static inline int __islessequalf(float_t __x, float_t __y) { return !(( sizeof((__x)) == sizeof(float) ? (__FLOAT_BITS((__x)) & 0x7fffffff) > 0x7f800000 : (__LONG_DOUBLE_BITS((__x)) & -1ULL>>1) > 0x7ffULL<<52 ) ? ((void)(__y),1) : ( sizeof((__y)) == sizeof(float) ? (__FLOAT_BITS((__y)) & 0x7fffffff) > 0x7f800000 : (__LONG_DOUBLE_BITS((__y)) & -1ULL>>1) > 0x7ffULL<<52 )) && __x <= __y; }
static inline int __islessequal(double_t __x, double_t __y) { return !(( sizeof((__x)) == sizeof(float) ? (__FLOAT_BITS((__x)) & 0x7fffffff) > 0x7f800000 : (__LONG_DOUBLE_BITS((__x)) & -1ULL>>1) > 0x7ffULL<<52 ) ? ((void)(__y),1) : ( sizeof((__y)) == sizeof(float) ? (__FLOAT_BITS((__y)) & 0x7fffffff) > 0x7f800000 : (__LONG_DOUBLE_BITS((__y)) & -1ULL>>1) > 0x7ffULL<<52 )) && __x <= __y; }
static inline int __islessequall(long double __x, long double __y) { return !(( sizeof((__x)) == sizeof(float) ? (__FLOAT_BITS((__x)) & 0x7fffffff) > 0x7f800000 : (__LONG_DOUBLE_BITS((__x)) & -1ULL>>1) > 0x7ffULL<<52 ) ? ((void)(__y),1) : ( sizeof((__y)) == sizeof(float) ? (__FLOAT_BITS((__y)) & 0x7fffffff) > 0x7f800000 : (__LONG_DOUBLE_BITS((__y)) & -1ULL>>1) > 0x7ffULL<<52 )) && __x <= __y; }
static inline int __islessgreaterf(float_t __x, float_t __y) { return !(( sizeof((__x)) == sizeof(float) ? (__FLOAT_BITS((__x)) & 0x7fffffff) > 0x7f800000 : (__LONG_DOUBLE_BITS((__x)) & -1ULL>>1) > 0x7ffULL<<52 ) ? ((void)(__y),1) : ( sizeof((__y)) == sizeof(float) ? (__FLOAT_BITS((__y)) & 0x7fffffff) > 0x7f800000 : (__LONG_DOUBLE_BITS((__y)) & -1ULL>>1) > 0x7ffULL<<52 )) && __x != __y; }
static inline int __islessgreater(double_t __x, double_t __y) { return !(( sizeof((__x)) == sizeof(float) ? (__FLOAT_BITS((__x)) & 0x7fffffff) > 0x7f800000 : (__LONG_DOUBLE_BITS((__x)) & -1ULL>>1) > 0x7ffULL<<52 ) ? ((void)(__y),1) : ( sizeof((__y)) == sizeof(float) ? (__FLOAT_BITS((__y)) & 0x7fffffff) > 0x7f800000 : (__LONG_DOUBLE_BITS((__y)) & -1ULL>>1) > 0x7ffULL<<52 )) && __x != __y; }
static inline int __islessgreaterl(long double __x, long double __y) { return !(( sizeof((__x)) == sizeof(float) ? (__FLOAT_BITS((__x)) & 0x7fffffff) > 0x7f800000 : (__LONG_DOUBLE_BITS((__x)) & -1ULL>>1) > 0x7ffULL<<52 ) ? ((void)(__y),1) : ( sizeof((__y)) == sizeof(float) ? (__FLOAT_BITS((__y)) & 0x7fffffff) > 0x7f800000 : (__LONG_DOUBLE_BITS((__y)) & -1ULL>>1) > 0x7ffULL<<52 )) && __x != __y; }
static inline int __isgreaterf(float_t __x, float_t __y) { return !(( sizeof((__x)) == sizeof(float) ? (__FLOAT_BITS((__x)) & 0x7fffffff) > 0x7f800000 : (__LONG_DOUBLE_BITS((__x)) & -1ULL>>1) > 0x7ffULL<<52 ) ? ((void)(__y),1) : ( sizeof((__y)) == sizeof(float) ? (__FLOAT_BITS((__y)) & 0x7fffffff) > 0x7f800000 : (__LONG_DOUBLE_BITS((__y)) & -1ULL>>1) > 0x7ffULL<<52 )) && __x > __y; }
static inline int __isgreater(double_t __x, double_t __y) { return !(( sizeof((__x)) == sizeof(float) ? (__FLOAT_BITS((__x)) & 0x7fffffff) > 0x7f800000 : (__LONG_DOUBLE_BITS((__x)) & -1ULL>>1) > 0x7ffULL<<52 ) ? ((void)(__y),1) : ( sizeof((__y)) == sizeof(float) ? (__FLOAT_BITS((__y)) & 0x7fffffff) > 0x7f800000 : (__LONG_DOUBLE_BITS((__y)) & -1ULL>>1) > 0x7ffULL<<52 )) && __x > __y; }
static inline int __isgreaterl(long double __x, long double __y) { return !(( sizeof((__x)) == sizeof(float) ? (__FLOAT_BITS((__x)) & 0x7fffffff) > 0x7f800000 : (__LONG_DOUBLE_BITS((__x)) & -1ULL>>1) > 0x7ffULL<<52 ) ? ((void)(__y),1) : ( sizeof((__y)) == sizeof(float) ? (__FLOAT_BITS((__y)) & 0x7fffffff) > 0x7f800000 : (__LONG_DOUBLE_BITS((__y)) & -1ULL>>1) > 0x7ffULL<<52 )) && __x > __y; }
static inline int __isgreaterequalf(float_t __x, float_t __y) { return !(( sizeof((__x)) == sizeof(float) ? (__FLOAT_BITS((__x)) & 0x7fffffff) > 0x7f800000 : (__LONG_DOUBLE_BITS((__x)) & -1ULL>>1) > 0x7ffULL<<52 ) ? ((void)(__y),1) : ( sizeof((__y)) == sizeof(float) ? (__FLOAT_BITS((__y)) & 0x7fffffff) > 0x7f800000 : (__LONG_DOUBLE_BITS((__y)) & -1ULL>>1) > 0x7ffULL<<52 )) && __x >= __y; }
static inline int __isgreaterequal(double_t __x, double_t __y) { return !(( sizeof((__x)) == sizeof(float) ? (__FLOAT_BITS((__x)) & 0x7fffffff) > 0x7f800000 : (__LONG_DOUBLE_BITS((__x)) & -1ULL>>1) > 0x7ffULL<<52 ) ? ((void)(__y),1) : ( sizeof((__y)) == sizeof(float) ? (__FLOAT_BITS((__y)) & 0x7fffffff) > 0x7f800000 : (__LONG_DOUBLE_BITS((__y)) & -1ULL>>1) > 0x7ffULL<<52 )) && __x >= __y; }
static inline int __isgreaterequall(long double __x, long double __y) { return !(( sizeof((__x)) == sizeof(float) ? (__FLOAT_BITS((__x)) & 0x7fffffff) > 0x7f800000 : (__LONG_DOUBLE_BITS((__x)) & -1ULL>>1) > 0x7ffULL<<52 ) ? ((void)(__y),1) : ( sizeof((__y)) == sizeof(float) ? (__FLOAT_BITS((__y)) & 0x7fffffff) > 0x7f800000 : (__LONG_DOUBLE_BITS((__y)) & -1ULL>>1) > 0x7ffULL<<52 )) && __x >= __y; }
# 181 "/opt/microchip/xc16/v2.00/bin/bin/../../include/math.h" 3 4
float acosf(float);
float acoshf(float);
float asinf(float);
float asinhf(float);
...
# 334 "/opt/microchip/xc16/v2.00/bin/bin/../../include/math.h" 3 4
extern int signgam;
...
float y1f(float);
float ynf(int, float);
# 5 "AX5043_NBM/inc/radio.h" 2
# 1 "/opt/microchip/xc16/v2.00/bin/bin/../../include/stdlib.h" 1 3 4
# 19 "/opt/microchip/xc16/v2.00/bin/bin/../../include/stdlib.h" 3 4
# 1 "/opt/microchip/xc16/v2.00/bin/bin/../../include/bits/alltypes.h" 1 3 4
# 32 "/opt/microchip/xc16/v2.00/bin/bin/../../include/bits/alltypes.h" 3 4
typedef short unsigned int wchar_t;
# 195 "/opt/microchip/xc16/v2.00/bin/bin/../../include/bits/alltypes.h" 3 4
typedef unsigned int size_t;
# 20 "/opt/microchip/xc16/v2.00/bin/bin/../../include/stdlib.h" 2 3 4
...
# 99 "/opt/microchip/xc16/v2.00/bin/bin/../../include/stdlib.h" 3 4
...
# 1 "/opt/microchip/xc16/v2.00/bin/bin/../../include/alloca.h" 1 3 4
# 9 "/opt/microchip/xc16/v2.00/bin/bin/../../include/alloca.h" 3 4
# 1 "/opt/microchip/xc16/v2.00/bin/bin/../../include/bits/alltypes.h" 1 3 4
# 10 "/opt/microchip/xc16/v2.00/bin/bin/../../include/alloca.h" 2 3 4

void *alloca(size_t);
# 139 "/opt/microchip/xc16/v2.00/bin/bin/../../include/stdlib.h" 2 3 4
char *mktemp (char *);
...
int clearenv(void);
# 6 "AX5043_NBM/inc/radio.h" 2
# 34 "AX5043_NBM/inc/radio.h"
typedef struct {
...
# 6 "AX5043_NBM/src/radioCommands.c" 2

void RadioACS(uint8_t cs) {
 PORTBbits.RB4 = cs & 0x01;
}
...
void RadioInterfacesInit() {
 ...
 radioInterfaces[0].SPICS = RadioACS;
 radioInterfaces[0].SPIReadWrite = SPI1ReadWrite;
...
uint8_t RadioInitBaseConfiguration(uint8_t radio) {
 ...
 AX5043PwrSetPowerMode(radio, PwrMode_Powerdown);
    ...
    AX5043GPIOCnfgSysClk(radio, SysClk_HighZ, 0);
 AX5043GPIOCnfgDCLK(radio, DCLK_HighZ, 0, 0);
 AX5043GPIOCnfgDATA(radio, DATA_HighZ, 0, 0);
 AX5043GPIOCnfgIRQ(radio, IRQ_Int_Req, 0, 0);
 AX5043GPIOCnfgAntSel(radio, AntSel_HighZ, 0, 0);
 AX5043GPIOCnfgPwrRamp(radio, PwrRamp_HighZ, 0, 0);


 AX5043GPIOSetDACInput(radio, DACInput_ValueR);
 AX5043GPIOSetDACInputShift(radio, 0x00);
 AX5043GPIOSetDACOutputMode(radio, 0x00);
 AX5043GPIOSetDACClockDoubling(radio, 0x00);
 ...
 AX5043PacketSetRSSIOffset(radio, 0xF5);


 uint8_t data = 0x0F;
 AX5043WriteLongAddress(radio, 0x0F00, &data, 1);
 data = 0x04;
 AX5043WriteLongAddress(radio, 0x0F08, &data, 1);
 data = 0x03;
 AX5043WriteLongAddress(radio, 0x0F0D, &data, 1);


 data = 0x03;
 AX5043WriteLongAddress(radio, 0x0F10, &data, 1);

 data = 0x07;
 AX5043WriteLongAddress(radio, 0x0F11, &data, 1);

 data = 0x06;

 AX5043WriteLongAddress(radio, 0x0F18, &data, 1);
 data = 0x07;
 AX5043WriteLongAddress(radio, 0x0F1C, &data, 1);
 data = 0x68;
 AX5043WriteLongAddress(radio, 0x0F21, &data, 1);
 data = 0xFF;
 AX5043WriteLongAddress(radio, 0x0F22, &data, 1);
 data = 0x84;
 AX5043WriteLongAddress(radio, 0x0F23, &data, 1);
 data = 0x98;
 AX5043WriteLongAddress(radio, 0x0F26, &data, 1);
 data = 0x3F;
 AX5043WriteLongAddress(radio, 0x0F30, &data, 1);
 data = 0xF0;
 AX5043WriteLongAddress(radio, 0x0F31, &data, 1);
 data = 0x3F;
 AX5043WriteLongAddress(radio, 0x0F32, &data, 1);
 data = 0xF0;
 AX5043WriteLongAddress(radio, 0x0F33, &data, 1);


 if(16000000 >= 24800000) {
  data = 0x11;
 }
 else {
  data = 0x10;
 }
 AX5043WriteLongAddress(radio, 0x0F35, &data, 1);

 data = 0x25;
 AX5043WriteLongAddress(radio, 0x0F44, &data, 1);
 data = 0xE7;

 AX5043WriteLongAddress(radio, 0x0F5F, &data, 1);
 data = 0x00;
 AX5043WriteLongAddress(radio, 0x0F72, &data, 1);

    AX5043SynthSetPLLLoopFilter(0, PLLLoop_Filter500kHz);

    AX5043SynthSetPLLVCOSelection(0, 1);
    AX5043SynthSetPLLVCO2Internal(0, 1);
    AX5043SynthSetPLLVCOEnableRefDivider(0, 1);


    data = 0x28;
    AX5043WriteLongAddress(0, 0x0F34, &data, 1);


    AX5043SynthSetFrequencyA(0, 0x09100001);


    AX5043SynthSetVCORangeA(radio, 0x8);
 ...
 while(AX5043SynthGetAutoRangingA(radio));
    ...
    uint8_t vcora = AX5043SynthGetVCORangeA(0);
    AX5043SynthSetVCORangeA(0, vcora);
# 165 "AX5043_NBM/src/radioCommands.c"
 ...
 AX5043RXParamSetRXFSKMaxDeviation(radio, 0x43C0);
 AX5043RXParamSetRXFSKMinDeviation(radio, 0xDC40);
 AX5043RXParamSetRXParameterNumber0(radio, 0);
 AX5043RXParamSetRXParameterNumber1(radio, 0);
 AX5043RXParamSetRXParameterNumber2(radio, 0);
 AX5043RXParamSetRXParameterNumber3(radio, 0);
...
# 251 "AX5043_NBM/src/radioCommands.c"
 AX5043PacketSetPacketChunkSize(radio, PacketChunkSize_240byte);
 AX5043PacketSetLengthByteSignificantBits(radio, 0x0F);
 ...
 AX5043PacketEnableStoreCRCBytes(radio, 0x01);
 ...
 AX5043PacketSetRXCoarseAGCTime(radio, 0x13, 0x03);
...
uint8_t RadioSetCenterFrequency(uint8_t radio, uint32_t frequency) {
 ...
 uint32_t freq = (uint32_t)((frequency * (16777216.f / 16000000)) + 0.5f);
...
uint8_t RadioSetAFCRange(uint8_t radio, uint32_t range) {
# 396 "AX5043_NBM/src/radioCommands.c"
 uint32_t afc = (uint32_t)((range * (16777216.f / 16000000)) + 0.5f);
 AX5043RXParamSetRXMaximumFrequencyOffset(radio, afc);

 return 0;
}
# 425 "AX5043_NBM/src/radioCommands.c"
uint8_t RadioSetAGCSpeed(uint8_t radio, uint8_t speed) {
...
uint8_t RadioSetFMDetectorBandwidth(uint8_t radio, uint32_t bandwidth) {
 ...
 uint8_t xtaldiv;
 AX5043ReadLongAddress(radio, 0x0F35, &xtaldiv, 1);
 if(xtaldiv == 0x11) {
  xtaldiv = 2;
 }
 else {
 ...
 uint32_t bitrate = (16000000 << 7) / (rxDr * decimation * xtaldiv);
...
# 489 "AX5043_NBM/src/radioCommands.c"
uint8_t RadioSetCRCMode(uint8_t radio, RadioCRC crcMode) {
...
# 521 "AX5043_NBM/src/radioCommands.c"
uint8_t RadioSetEncodingMode(uint8_t radio, RadioEncoder encMode) {
...
# 596 "AX5043_NBM/src/radioCommands.c"
uint8_t RadioSetFramingMode(uint8_t radio, RadioFraming frmMode) {
...
# 640 "AX5043_NBM/src/radioCommands.c"
uint8_t RadioSetModulation(uint8_t radio, RadioModulation modulation) {
 ...
 switch(modulation) {
  case RadioModulation_AM:
   ...
   AX5043GeneralSetModulation(radio, FM);
      ...
      AX5043RXParamSetAGCTargetAvgMagnitude0(radio, 0x79);
 ...
 if(modulation != RadioModulation_AM && modulation != RadioModulation_FM) {
  ...
  uint8_t expf = floorf(log2f(((float)rxRate / 4.f) / 8.f));
  uint8_t man = roundf(((float)rxRate / 4.f) / (1 << expf));
  AX5043PacketSetGainTimingRecovery0(radio, man, expf);
  AX5043PacketSetGainTimingRecovery1(radio, man, expf);
  AX5043PacketSetGainTimingRecovery2(radio, man, expf);
  AX5043PacketSetGainTimingRecovery3(radio, man, expf);

  expf = floorf(log2f(((float)rxRate / 64.f) / 8.f));
  man = roundf(((float)rxRate / 64.f) / (1 << expf));
  AX5043PacketSetGainDatarateRecovery0(radio, man, expf);
  AX5043PacketSetGainDatarateRecovery1(radio, man, expf);
  AX5043PacketSetGainDatarateRecovery2(radio, man, expf);
  AX5043PacketSetGainDatarateRecovery3(radio, man, expf);
  ...
  rxRate = (uint32_t)((16000000 << 7) / (((float)rxRate - 0.5f) * dec));
  uint16_t afskBW = (uint16_t)(rintf(2.f * log2f((float)16000000 / (32 * rxRate * dec * xtaldiv))));
  AX5043RXParamSetAFSKDetBandwitdh(radio, afskBW);
 }

 if(modulation == RadioModulation_BPSK) {

  AX5043TXParamSetPSKPulseLength(radio, PSKPulseLen_2);
 }
 else {

  AX5043TXParamSetPSKPulseLength(radio, PSKPulseLen_Off);
 }

 return 0;
}
# 783 "AX5043_NBM/src/radioCommands.c"
uint8_t RadioSetOperationMode(uint8_t radio, RadioMode opMode) {
...
uint8_t RadioSetBandwidth(uint8_t radio, uint32_t bandwidth) {
 ...
 uint8_t decimation = (uint8_t)((16000000 * 0.210858f) / (float)((bandwidth * xtaldiv) << 4));
...
uint8_t RadioSetIF(uint8_t radio, uint32_t frequency) {
 ...
 uint16_t ifF = (uint16_t)((frequency * xtaldiv) * (1048576.f / 16000000) + 0.5f);
...
uint8_t RadioSetRXDatarate(uint8_t radio, uint32_t bitrate) {
 ...
 uint8_t decimation = AX5043RXParamGetDecimation(radio);
 uint32_t rxDr = (16000000 << 7) / (bitrate * decimation * xtaldiv);
 AX5043RXParamSetRXDatarate(radio, rxDr);

 Modulations modulation = (Modulations)AX5043GeneralGetModulation(radio);
 if(modulation != FM) {

  uint8_t expf = floorf(log2f(((float)rxDr / 4.f) / 8.f));
  uint8_t man = roundf(((float)rxDr / 4.f) / (1 << expf));
  AX5043PacketSetGainTimingRecovery0(radio, man, expf);
  AX5043PacketSetGainTimingRecovery1(radio, man, expf);
  AX5043PacketSetGainTimingRecovery3(radio, man, expf);

  expf = floorf(log2f(((float)rxDr / 64.f) / 8.f));
  man = roundf(((float)rxDr / 64.f) / (1 << expf));
  AX5043PacketSetGainDatarateRecovery0(radio, man, expf);
  AX5043PacketSetGainDatarateRecovery1(radio, man, expf);
  AX5043PacketSetGainDatarateRecovery3(radio, man, expf);

  uint16_t afskBW = (uint16_t)(2.f * log2f((float)16000000 / (32 * bitrate * decimation * xtaldiv)) + 1.5f);
  AX5043RXParamSetAFSKDetBandwitdh(radio, afskBW);
 }
...
uint8_t RadioSetTXDatarate(uint8_t radio, uint32_t bitrate) {
 ...
 uint32_t txDr = (uint16_t)((bitrate * (16777216.f / 16000000)) + 0.5f);
...
uint8_t RadioSetTXDeviation(uint8_t radio, uint32_t deviation) {
 ...
 switch(modulation) {
  case FM: {
   fDev = (uint8_t)(roundf(15.0f - log2f((float)16000000 / deviation)));
   if(fDev > 0x07) {
    fDev = 0x07;
   }
   fDev += 0xC000;
  ...
  case AFSK: {
   ...
   fDev = (uint16_t)(((deviation * 0.858785f) * (16777216.f / 16000000)) + 0.5f);
   break;
  }
  default: {

   fDev = (uint32_t)(((deviation >> 1) * (16777216.f / 16000000)) + 0.5f);
   break;
  }
 }
...
uint8_t RadioSetAFSKSpaceFreq(uint8_t radio, uint16_t spaceFreq) {
 ...
 if(pwrMode == PwrMode_RXEN) {
  ...
  uint8_t decimation = AX5043RXParamGetDecimation(radio);
  afskSpace = (uint16_t)((((uint32_t)spaceFreq * (uint32_t)decimation * (uint32_t)xtaldiv) << 16) / (float)16000000 + 0.5f);
 }
 else {

  afskSpace = (uint16_t)(spaceFreq * (262144.f / 16000000) + 0.5f);
 }

 AX5043RXParamSetAFSKSpaceFrequency(radio, afskSpace);
...
uint8_t RadioSetAFSKMarkFreq(uint8_t radio, uint16_t markFreq) {
 ...
 if(pwrMode == PwrMode_RXEN) {
  ...
  uint8_t decimation = AX5043RXParamGetDecimation(radio);
  afskMark = (uint16_t)((((uint32_t)markFreq * (uint32_t)decimation * (uint32_t)xtaldiv) << 16) / (float)16000000 + 0.5f);
 }
 else {

  afskMark = (uint16_t)(markFreq * (262144.f / 16000000) + 0.5f);
 }

 AX5043RXParamSetAFSKMarkFrequency(radio, afskMark);

 return 0;
}
# 1148 "AX5043_NBM/src/radioCommands.c"
uint8_t RadioWriteFIFORepeatData(uint8_t radio, uint8_t dataByte, uint8_t count) {
 uint8_t fifoData[4];
...
# 1173 "AX5043_NBM/src/radioCommands.c"
uint8_t RadioWriteFIFOData(uint8_t radio, uint8_t data[], uint8_t dataLength) {
 ...
 fifoData[i++] = 0xE1;
 fifoData[i++] = dataLength + 1;
 fifoData[i++] = 0x01 | 0x02;
